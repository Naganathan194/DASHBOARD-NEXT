...
"[project]/app/api/databases/[db]/collections/[col]/documents/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        void _id;
        const client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToMongo"])();
        await client.db(db).collection(col).updateOne(buildQuery(id), {
            $set: {
                ...updateData,
                updatedAt: new Date()
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c941a27._.js.map